...
- Keep dependencies minimal. Preferred: `drizzle-orm`, `@neondatabase/serverless`, `zod`, `p-limit`. Ask before adding UI libraries — plain Tailwind is the default.
